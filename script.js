...
let adjective = document.getElementById("adjective1");
...
adjective.addEventListener("change", (e) => (adjective = e.target.value));
...
// };
 ...
 generateMadLibBtn.addEventListener("click", () => {
  const madLibsArr = [
    `Hot chocolate is a ${adjective} and ${adjective2} treat. You could never go
